...
LinphoneStatus linphone_proxy_config_set_server_addr(LinphoneProxyConfig *cfg, const char *server_addr){
	if (cfg->edit != NULL) {
		...
		//ms_message("Proxy config [%p] is not on edit mode", cfg);
		//return -1;

		// Do edit done here to ensure backward compatibility
		linphone_proxy_config_edit(cfg);
		int ret = linphone_account_params_set_server_addr(cfg->edit, server_addr);
...
LinphoneStatus linphone_proxy_config_set_identity_address(LinphoneProxyConfig *cfg, const LinphoneAddress *addr){
	if (cfg->edit != NULL) {
		...
		// Do edit done here to ensure backward compatibility
		linphone_proxy_config_edit(cfg);
		int ret = linphone_account_params_set_identity_address(cfg->edit, addr);
		linphone_proxy_config_done(cfg);
		return ret;
	}
}
...
const char *linphone_proxy_config_get_domain(const LinphoneProxyConfig *cfg){
	const LinphoneAddress *identity_address = linphone_account_params_get_identity_address(linphone_account_get_params(cfg->account));
...
const char *linphone_proxy_config_get_dial_prefix(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_international_prefix(linphone_account_get_params(cfg->account));
}
...
bool_t linphone_proxy_config_get_dial_escape_plus(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_dial_escape_plus_enabled(linphone_account_get_params(cfg->account));
}
...
bool_t linphone_proxy_config_quality_reporting_enabled(LinphoneProxyConfig *cfg){
	return linphone_account_params_get_quality_reporting_enabled(linphone_account_get_params(cfg->account));
}
...
int linphone_proxy_config_get_quality_reporting_interval(LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_quality_reporting_interval(linphone_account_get_params(cfg->account));
}
...
const char *linphone_proxy_config_get_quality_reporting_collector(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_quality_reporting_collector(linphone_account_get_params(cfg->account));
}
...
{
	return linphone_account_params_get_realm(linphone_account_get_params(cfg->account));
}
...
const bctbx_list_t* linphone_proxy_config_get_routes(const LinphoneProxyConfig *cfg) {
	return AccountParams::toCpp(linphone_account_get_params(cfg->account))->getRoutesString();
}

const LinphoneAddress *linphone_proxy_config_get_identity_address(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_identity_address(linphone_account_get_params(cfg->account));
}

const char *linphone_proxy_config_get_identity(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_identity(linphone_account_get_params(cfg->account));
}

bool_t linphone_proxy_config_publish_enabled(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_publish_enabled(linphone_account_get_params(cfg->account));
}

const char *linphone_proxy_config_get_server_addr(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_server_addr(linphone_account_get_params(cfg->account));
}
...
int linphone_proxy_config_get_expires(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_expires(linphone_account_get_params(cfg->account));
}

bool_t linphone_proxy_config_register_enabled(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_register_enabled(linphone_account_get_params(cfg->account));
}
...
const char *linphone_proxy_config_get_contact_parameters(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_contact_parameters(linphone_account_get_params(cfg->account));
}

const char *linphone_proxy_config_get_contact_uri_parameters(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_contact_uri_parameters(linphone_account_get_params(cfg->account));
}
...
LinphoneProxyConfig *linphone_proxy_config_get_dependency(LinphoneProxyConfig *cfg) {
	...
	return Account::toCpp(dependency)->getConfig();
}
...
const char *linphone_proxy_config_get_idkey(LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_idkey(linphone_account_get_params(cfg->account));
}
...
void linphone_proxy_config_set_privacy(LinphoneProxyConfig *params, LinphonePrivacyMask privacy) {
	if (params->edit != NULL) {
		...
		ms_message("Proxy config [%p] is not on edit mode", params);
	}
}

LinphonePrivacyMask linphone_proxy_config_get_privacy(const LinphoneProxyConfig *params) {
	return linphone_account_params_get_privacy(linphone_account_get_params(params->account));
}
...
int linphone_proxy_config_get_publish_expires(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_publish_expires(linphone_account_get_params(cfg->account));
}
...
LinphoneAVPFMode linphone_proxy_config_get_avpf_mode(const LinphoneProxyConfig *cfg){
	return linphone_account_params_get_avpf_mode(linphone_account_get_params(cfg->account));
}
...
uint8_t linphone_proxy_config_get_avpf_rr_interval(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_avpf_rr_interval(linphone_account_get_params(cfg->account));
}
...
const char * linphone_proxy_config_get_ref_key(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_ref_key(linphone_account_get_params(cfg->account));
}
...
LinphoneNatPolicy * linphone_proxy_config_get_nat_policy(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_nat_policy(linphone_account_get_params(cfg->account));
}
...
const char * linphone_proxy_config_get_conference_factory_uri(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_conference_factory_uri(linphone_account_get_params(cfg->account));
}

bool_t linphone_proxy_config_is_push_notification_allowed(const LinphoneProxyConfig *cfg) {
	return linphone_account_params_get_push_notification_allowed(linphone_account_get_params(cfg->account));
}
...
void linphone_proxy_config_set_push_notification_allowed(LinphoneProxyConfig *cfg, bool_t is_allowed) {
	if (cfg->edit != NULL) {
		...
		// Do edit and done here to keep backward compatibility
		linphone_proxy_config_edit(cfg);
		linphone_account_params_set_push_notification_allowed(cfg->edit, is_allowed);
		linphone_proxy_config_done(cfg);
	}
